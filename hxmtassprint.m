function hxmtassprint(filename)
%HXMTASSVIEWER
...
if strcmp(demo_mode,'std')
    epsname={['crab',num2str(simobs.Sig),...
        'sig_ddm_image_',num2str(t),'itr','.eps']};
else
    epsname={[modelstr,'_ddm_im_',regionstr,num2str(t),'itr',...
      '.eps']};
end
if ~isempty(epsname)
...
if strcmp(demo_mode,'std')
    ...
    epsname={[modelstr,'_ddm_ct_',regionstr,num2str(t),'itr',...
      '.eps']};
end
if ~isempty(epsname)
    if ~isempty(epsname{1})
